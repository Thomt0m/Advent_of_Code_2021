...
namespace Advent_of_Code
{
    class D06_Lanternfish
    {
        ...
        */
        ...
        public D06_Lanternfish(int[] input)
        {
            ...
            uint[] startSchool = new uint[9];
            for (int i = 0; i < input.Length; i++)
            {
                startSchool[input[i]]++;
            }

            ulong[] school = new ulong[startSchool.Length];
            startSchool.CopyTo(school, 0);

            for (int day = 0; day < 80; day++)
            {
                ulong birth = school[0];
            ...
            Console.WriteLine("1. Number of Lanternfish after 80 days = " + count);
